...
@Service
public class CouponNameCodeParserService {

    private final ObjectMapper objectMapper;

    public CouponNameCodeParserService(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }


    public CouponNameCode parse(String rawResponse) {
        if (rawResponse == null) {
        ...
        try {
            return objectMapper.readValue(normalizedJson, CouponNameCode.class);
        } catch (Exception e) {
